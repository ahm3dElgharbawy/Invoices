					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path>@if(auth()->user()->unreadNotifications->count()) </svg><span class=" pulse"></span> @endif</a>
								<div class="dropdown-menu" id="live">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">الاشعارات</h6>
											<a href='{{url('mark-all-as-read')}}' class="badge badge-pill badge-warning mr-auto my-auto float-left">تعليم الكل كمقروء</a>
										</div>
									...
									<div class="main-notification-list Notification-scroll">
                                        @foreach(auth()->user()->unreadNotifications as $notification)
                                            <a class="d-flex p-3 border-bottom" href="{{url('invoices/details/'.$notification->data['invoice_id'])}}">
                                                <div class="notifyimg bg-primary" style="height: fit-content;">
