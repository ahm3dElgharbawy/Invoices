...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ استعراض وطباعة الفاتورة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class=" main-content-body-invoice" id="print">
							<div class="card card-invoice">
								<div class="card-body">
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="tx-right">الاجمالي بدون الضريبة</td>
													<td class="tx-right" colspan="2">{{number_format($invoice->total - $invoice->value_vat,2)}}</td>
												</tr>
												<tr>
													<td class="tx-right">قيمة الضريبة({{$invoice->rate_vat}})</td>
									...
									<hr class="mg-b-40">
									<button  class="btn btn-danger float-left mb-5 mr-2" id="print_btn" onclick="printInvoice()">
...
<script src="{{URL::asset('assets/plugins/chart.js/Chart.bundle.min.js')}}"></script>
    <script>
        function printInvoice(){
            var invoice_body = document.getElementById('print').innerHTML;
