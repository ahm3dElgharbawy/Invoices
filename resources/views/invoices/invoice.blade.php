        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="export_excel" class="modal-effect btn btn-sm btn-success" style="color:white"
                       title="{{ __(' تصدير الفاتورة كملف Excel') }}"><i
                            class="fas fa-file-export"></i>&nbsp; تصدير </a><br><br>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    data-toggle="dropdown" id="dropdownMenuButton" type="button">العملية<i
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                @endcan
                                                @can('حذف الفاتورة')
                                                    <a class="dropdown-item" href="#modalDeleteInvoice" data-toggle="modal"
                                                       data-id="{{$invoice->id}}"
                                                       data-invoice_number="{{$invoice->invoice_number}}">حذف</a>
                                                @endcan
                                                @can('تغير حالة الدفع')
                                                ...
                                                @can('ارشفة الفاتورة')
                                                    <a class="dropdown-item"
                                                       href="{{url('invoices/archiving/'.$invoice->id)}}">اضافة الي
                                                        الارشيف</a>
                                                @endcan
                                                @can('طباعة الفاتورة')
                                                    <a class="dropdown-item" href="{{url('invoices/print/'.$invoice->id)}}">استعراض
                                                        وطباعة</a>
                                                @endcan
                                            </div>
                                        </div>
                ...
                <div class="modal-body">
                    <form action="{{ url('invoices/destroy') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="invoice_number" class="form-label">هل انت متاكد من انك تريد حذف هذة الفاتورة
                                ؟</label>
